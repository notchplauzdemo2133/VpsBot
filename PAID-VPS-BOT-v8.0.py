...
DISCORD_TOKEN = os.getenv('DISCORD_TOKEN', 'ENTER_BOT_TOKEN_HERE')
BOT_NAME = os.getenv('BOT_NAME', 'Example')
PREFIX = os.getenv('PREFIX', '!')
YOUR_SERVER_IP = os.getenv('YOUR_SERVER_IP', '127.0.0.1')
MAIN_ADMIN_ID = int(os.getenv('MAIN_ADMIN_ID', 'ENTER_ADMIN_ID'))
VPS_USER_ROLE_ID = int(os.getenv('VPS_USER_ROLE_ID', 'ENTER_VPS_USER_ROLE_ID'))
DEFAULT_STORAGE_POOL = os.getenv('DEFAULT_STORAGE_POOL', 'default')
BOT_VERSION = os.getenv('BOT_VERSION', 'v8.0')
BOT_DEVELOPER = os.getenv('BOT_DEVELOPER', 'MrPain/Pain09X')
...
if __name__ == "__main__":
    if DISCORD_TOKEN:
        ...
        logger.error("No Discord token found in DISCORD_TOKEN environment variable.")d token found in DISCORD_TOKEN environment variable.")